class MinesweeperController:
    ...
    def startNewGame(self):
        ...
        try:
            ...
            self.model.startGame(self.model.rowCount, self.model.columnCount,
                                 self.model.mineCount)
    ...
    def onRightClick(self, row, column):
        ...
        self.view.blockCell(row, column,
                            self.model.getCell(row, column).state == 'flagged')
        self.view.syncWithModel()
