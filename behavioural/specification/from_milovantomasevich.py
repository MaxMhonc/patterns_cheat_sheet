# https://milovantomasevic.com/courses/python-design-patterns-specification/
...
class AndSpecification(CompositeSpecification):
    ...
    def is_satisfied_by(self, candidate):
        return bool(self._one.is_satisfied_by(
            candidate) and self._other.is_satisfied_by(candidate))
...
class OrSpecification(CompositeSpecification):
    ...
    def is_satisfied_by(self, candidate):
        return bool(self._one.is_satisfied_by(
            candidate) or self._other.is_satisfied_by(candidate))
...
if __name__ == '__main__':
    ...
    root_specification = UserSpecification().and_specification(
