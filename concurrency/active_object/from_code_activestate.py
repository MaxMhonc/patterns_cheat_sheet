# https://rosettacode.org/wiki/Active_object#Python
...
class Message:
    """Represents a message forwarded to a passive object by an active_object"""
    ...
    def __getattr__(self, attrname):
        ...
        if hasattr(fun, '__call__'):
            ...
            raise AttributeError(
                "Active object does not support this function.")
